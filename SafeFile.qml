...
QtObject {
    ...
    readonly property string helper: [
        ...
        "# Create the parent directory on first use (e.g. a managed file whose",
        "# directory nothing else is responsible for creating). A no-op when it",
        "# already exists; still fails closed if creation is impossible.",
